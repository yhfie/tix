<x-layouts.admin title="Manajemen Event">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.events.show', $event->id) }}" class="btn btn-sm btn-info mr-2">
                                Detail
                            </a>
                            <a href="{{ route('admin.events.edit', $event->id) }}" class="btn btn-sm btn-primary mr-2">
                                Edit
                            </a>
                            <button class="btn btn-sm bg-red-500 text-white" onclick="openDeleteModal(this)" data-id="{{ $event->id }}">
                                Hapus
                            </button>
                        </td>
                    </tr>
    ...
    <dialog id="delete_modal" class="modal">
        <form method="POST" class="modal-box">
            ...
            <p>Apakah Anda yakin ingin menghapus "{{ $event->name }}"?</p>
